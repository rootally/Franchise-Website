				...
				$.getJSON('JSONGridProcess.php',function(jsonAry)
			 	{
					...
					if(jsonAry.length==0)
					...
					else
						{
							$("#tbl").empty();
							 //
							$("#tbl").append("<tr><th><center> Name <th><center>Mobile<th><center>City<th><center>Status<th colspan=3><center>Action </tr> </thead>");
						...
						row.append("<td><input type='button' class='btn btn-primary' value='Approved' onClick=doUpdate("+i+",1)>");
						row.append("<td><input type='button' class='btn btn-danger' value='Reject' onClick=doUpdate("+i+",2)>");
						row.append("<td><input type='button' class='btn btn-warning' value='Pending' onClick=doUpdate("+i+",3)>");
